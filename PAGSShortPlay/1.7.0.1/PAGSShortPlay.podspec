...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/6.5.1.1/SDK.zip", :sha256 => "efc06b3820aef942530d171531ff7dd25637833e78b81f5554a6ed97aba6236b" }
  s.platform         = :ios, "12.0"
