...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/gjw1024630744/Specs"
	s.source   = { :git => 'https://github.com/gjw1024630744/IOSSDK.git', :tag => '1.9.0.0.reelnowmix' }
  s.platform         = :ios, "12.0"
  ...
  s.subspec 'standard' do |ss|
    ...
    ss.dependency 'TTSDKFramework/Player-SR', '1.49.300.2-standard'
  end
  
  # 高级版 subspec
  s.subspec 'premium' do |ss|
    ss.dependency 'PAGSShortPlay/Core'
    ss.dependency 'TTSDKFramework/Player-SR', '1.49.300.2-premium'
  end
end